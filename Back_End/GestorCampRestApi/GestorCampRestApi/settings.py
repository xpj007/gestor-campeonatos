"""
Django settings for GestorCampRestApi project.
...
SECRET_KEY = 'django-insecure-qc$743b50a=@4k+hoh0-e*1!qx43cpx0901k%s8w0a@*^d&nk$'
...
ROOT_URLCONF = 'GestorCampRestApi.urls'
...
WSGI_APPLICATION = 'GestorCampRestApi.wsgi.application'
